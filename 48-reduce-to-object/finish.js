...
function quantitiesByCategories(products) {
  return  products.reduce((qtysByCtegories, product) => {
    qtysByCtegories[product.category] = (qtysByCtegories[product.category] || 0) + product.quantity

    return qtysByCtegories
  }, {})
